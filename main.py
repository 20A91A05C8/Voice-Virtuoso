...
def login():
    ...
    def log_in():
        ...
        try:
            ...
            if data:
                tkMessageBox.showinfo("Voice Virtuoso","Logged In Successfully !!!")
                root.destroy()
                f = open("cred.txt","w")
                f.write(str(data[0]))
                f.close()
                ...
                tkMessageBox.showinfo("Voice Virtuoso","Failed To Login !!!")
                em.set("")
                passwrd.set("")
        except Exception as e:
            tkMessageBox.showinfo("Voice Virtuoso",e)
...
def signup():
    ...
    def reg():
        ...
        try:
            ...
            conn.commit()
            conn.close()
            tkMessageBox.showinfo("Voice Virtuoso","Registered Successfully !!!")
            root2.destroy()
            login()
        except Exception as e:
            tkMessageBox.showinfo("Voice Virtuoso",e)
...
def mainwindow():
    ...
    if avg>0:
        if avg<=3 :
            tkMessageBox.showinfo("Voice Virtuoso","Most suitable level for you is Letters")
        elif avg>3 and avg<=7.5:
            tkMessageBox.showinfo("Voice Virtuoso","Most suitable level for you is Words")
        else:
            tkMessageBox.showinfo("Voice Virtuoso","Most suitable level for you is sentences")
    ...
    class SentencePhoneticsGame:
        def __init__(self, master):
            self.master = master
            self.master.title("Voice Virtuoso Game")
